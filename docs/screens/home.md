...
|-----------|-------------|
| `RadarView` | Canvas-based radar visualization |
| `CurrentLocationCard` | Displays current GPS coordinates and accuracy |
| `SatellitesList` | Shows satellite details in a list |
